...
!function(a) {
    "use strict";
    "function" == typeof define && define.amd ? define(["jquery"], a) : "undefined" != typeof module && module.exports ? module.exports = a(require("jquery")):layui&&layui.define?layui.define(function(f){a(layui.$);f("jstree",{})}) : a(jQuery)
}(function(a, b) {
    "use strict";
    var jQuery = layui.$;
    if (!a.jstree) {
        ...
        a.jstree = {
            ...
            a.jstree.core.prototype = {
                ...
                get_node: function(b, c) {
                    b && b.id && (b = b.id),
                    b instanceof jQuery && b.length && b[0].id && (b = b[0].id);
                    var d;
                    try {
                    ...
                    if (null !== this.element) {
                        ...
                        var f = null
                            ...
                            if (c.length && c[0].id !== b && c[0].parent !== b) {
                                ...
                                for (o = 0,
                                         p = c.length; p > o; o++)
                                    k[c[o].parent.toString()] ? (k[c[o].parent.toString()].children.push(c[o].id.toString()),
                                        l.children_d.push(c[o].id.toString())) : (this._data.core.last_error = {
                                        error: "parse",
                                        plugin: "core",
                                        id: "core_07",
